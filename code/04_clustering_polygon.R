...
file.copy(from = "data/Augusta2011_seg50.tif", to = "tmp")
file.copy(from = "data/nlcd_colors.txt", to = "tmp")

setwd("tmp/")

## gpat clustering  prep -----------------------------------------------------
system("gpat_polygon -i Augusta2011.tif -e Augusta2011_seg50.tif -o Augusta2011_psign.txt")
system("gpat_distmtx -i Augusta2011_psign.txt -o Augusta2011_matrix4.csv")
