...
system("gpat_segment -i Augusta2011_grid100d -o Augusta2011_seg100.tif -v Augusta2011_seg100.shp --lthreshold=0.1 --uthreshold=0.3")
...
system("gpat_segment -i Augusta2011_grid100e -o Augusta2011_seg100.tif -v Augusta2011_seg100.shp --lthreshold=0.1 --uthreshold=0.3")
