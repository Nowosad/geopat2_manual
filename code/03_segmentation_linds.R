...
system("gpat_globnorm -i Augusta2011_grid100 -o Augusta2011_grid100_norm -m ind01")
system("gpat_segment -i Augusta2011_grid100_norm -o Augusta2011_seg100.tif -v Augusta2011_seg100.gpkg --lthreshold=0.1 --uthreshold=0.3")
system("gpat_segquality -i Augusta2011_grid100_norm -s Augusta2011_seg100.tif -g Augusta2011_seg100_ih.tif -o Augusta2011_seg100_is.tif")
