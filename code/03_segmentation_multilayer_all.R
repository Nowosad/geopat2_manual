...
system("gpat_segment -i Augusta2011_grid100 -i geomorph_grid100 -o multilayer_seg1.tif -v multilayer_seg1.tif.gpkg -a")
system("gpat_segquality -i Augusta2011_grid100 -s multilayer_seg1.tif -g Augusta2011_seg100_ih.tif -o Augusta2011_seg100_is.tif")
system("gpat_segquality -i geomorph_grid100 -s multilayer_seg1.tif -g geomorph_seg100_ih.tif -o geomorph_seg100_is.tif")
