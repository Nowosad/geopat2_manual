...
system("gpat_segment -i Augusta2011_grid100 -o Augusta2011_seg100.tif -v Augusta2011_seg100.gpkg --lthreshold=0.1 --uthreshold=0.3 --size=100")
...
system("gpat_segment -i Augusta20111_grid100 -o Augusta20111_seg100.tif -v Augusta20111_seg100.gpkg --lthreshold=0.1 --uthreshold=0.3 --size=100")
