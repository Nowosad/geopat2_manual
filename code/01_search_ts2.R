...
ta_files = dir("raw_data/GBmeteoSRC/", pattern = "ta", full.names = TRUE)
file.copy(from = ta_files, to = "tmp")
...
system("gpat_gridts -i GB_pr01.tif -i GB_pr02.tif -i GB_pr03.tif -i GB_pr04.tif -i GB_pr05.tif -i GB_pr06.tif -i GB_pr07.tif -i GB_pr08.tif -i GB_pr09.tif -i GB_pr10.tif -i GB_pr11.tif -i GB_pr12.tif  -i GB_ta01.tif -i GB_ta02.tif -i GB_ta03.tif -i GB_ta04.tif -i GB_ta05.tif -i GB_ta06.tif -i GB_ta07.tif -i GB_ta08.tif -i GB_ta09.tif -i GB_ta10.tif -i GB_ta11.tif -i GB_ta12.tif -o GB_pr_grid -d 2")
...
system("gpat_search -i GB_pr_grid_norm -r query_signatures_ts.txt -m euc")
...
system("gpat_gridts -i GB_pr01.tif -i GB_pr02.tif -i GB_pr03.tif -i GB_pr04.tif -i GB_pr05.tif -i GB_pr06.tif -i GB_pr07.tif -i GB_pr08.tif -i GB_pr09.tif -i GB_pr10.tif -i GB_pr11.tif -i GB_pr12.tif  -i GB_ta01.tif -i GB_ta02.tif -i GB_ta03.tif -i GB_ta04.tif -i GB_ta05.tif -i GB_ta06.tif -i GB_ta07.tif -i GB_ta08.tif -i GB_ta09.tif -i GB_ta10.tif -i GB_ta11.tif -i GB_ta12.tif -o GB_pr_grid -d 2 -n")
