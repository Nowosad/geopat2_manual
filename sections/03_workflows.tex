...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{ts_seg.png}
	\caption{Segments of montly precipitation temporal patterns for Great Britain}
	\label{FIG:SEGTS1}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Inhomogenety and isolation metrics for the segmentation of montly precipitation temporal patterns for Great Britain}
	\label{FIG:SEGTS2}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Quality of the segmentation of montly precipitation temporal patterns for Great Britain}
	\label{FIG:SEGTS3}
\end{figure}
