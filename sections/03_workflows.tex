...
The third step is to calculate and export a distance matrix with {\it gpat_distmtx}.
...
For this purpose, we need to have twelve rasters with values of a monthly sum of precipitation for the whole area of Great Britain and the list of the cities coordinates (the GB_cities.csv file).
