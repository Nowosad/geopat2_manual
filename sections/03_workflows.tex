...
Examples of time-series analysis were based on montly sums of precipitation for area of Great Britain from the WorldClim database (Figure \ref{FIG:PRCP}).
...
\begin{figure}[H]
	...
	\caption{Montly sums of precipitation for area of Great Britain used in the time-series examples}
	\label{FIG:PRCP}
\end{figure}
