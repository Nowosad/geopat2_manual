...
It is because one cell has resolution of 30 meters, and firstly using {\tt gpat_gridhis} it is combined into a grid of signature of 3 kilometers (30 meters x 100 = 3 kilometers), and secondly using {\tt gpat_segment} it is merged into bricks of four grids of signatures (6 by 6 kilometers). 
