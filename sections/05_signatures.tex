...
\subsection{Cartesian product (prod)}
...
\subsection{Class co-occurrence histogram (cooc)}
...
\subsection{Decomposition histogram (fdec and sdec)}
...
\subsection{Local binary pattern histogram (lbp)}

\subsection{Landscape indices vector (lind and linds)}

\subsection{J-Coocurrence vector (jcov)}

\subsection{Shannon entropy (ent)}
